"""
Mode-Adaptive Neural Network (MANN): a gating network maps the PAE phase parameters
to per-sample blending weights over a set of "expert" linear layers, which are
combined to predict future joint angles/moments (Zhang et al., "Mode-Adaptive
Neural Networks for Quadruped Motion Control", SIGGRAPH 2018 - gating/expert-blend
design adapted here for IMU-driven human motion prediction).
...
class Model(torch.nn.Module):
    """Gating network (ELU MLP) + mixture-of-experts linear predictor, gated by PAE phase features."""
